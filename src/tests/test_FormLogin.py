...
class LoginInmofianza(Selenium,unittest.TestCase): 
    ...
    def testLogin_AccesoCorrecto(self):
        URL_TOKEN=Inicializar.URL_TOKEN
        USER_TOKEN=Inicializar.USER_TOKEN
        PASSWORD_TOKEN=Inicializar.PASSWORD_TOKEN
        APLICATION_TOKEN=Inicializar.APLICATION_TOKEN
        URL_SERVICES=Inicializar.URL_SERVICES
        ...
        idfianza=int(str(now.month)+str(now.day)+str(now.hour)+str(now.minute)+str(now.second))
        CaseInmofianza.AssembleJson(
        URL_TOKEN,
        USER_TOKEN,
        PASSWORD_TOKEN,
        APLICATION_TOKEN,
        ...
        a_numeroDocumento,
        a_contactoCelular,
        a_correoNotificaciones,
        a_fechaNacimiento,
        a_fechaExpedicionDocumento,
        a_ciudadExpedicionDocumento,
        d_primerNombre,
        d_segundoNombre,
        d_primerApellido,        
        d_segundoApellido,
        ...
        d_numeroDocumento,
        d_contactoCelular,
        d_correoNotificaciones,
        d_fechaNacimiento,
        d_fechaExpedicionDocumento,
        d_ciudadExpedicionDocumento,        
        nombreDocumento_a,
        nombreDocumento_b,
        r_primerNombre,
        r_segundoNombre,
        ...
        r_ciudadDocumento,
        r_numeroNit,
        r_digitoVerificacion,
        r_contactoCelular,
        r_correoNotificaciones,
        r_fechaNacimiento,
        r_fechaExpedicionDocumento,
        r_emailContactoInmobiliaria,
        ...
        i_ciudadDocumento,
        i_numeroNit,
        i_digitoVerificacion,
        i_contactoCelular,
        i_correoNotificaciones,
        i_fechaNacimiento,
        i_fechaExpedicionDocumento,
        i_emailContactoInmobiliaria,
        ...
        nombreAsesor,
        idfianza)
        EventLogin.Loguin(self,a_numeroDocumento,a_numeroDocumento)
